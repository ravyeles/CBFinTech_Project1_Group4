...
class App(ctk.CTk):
    def __init__(self):
        ...
        display_results_widget = ctk.CTkTextbox(self, wrap=ctk.WORD, width=50, height=20)
        display_results_widget.grid(column=0, row=4, columnspan=3, rowspan=10, padx=5, pady=5, sticky=ctk.W+ctk.E+ctk.N+ctk.S)
